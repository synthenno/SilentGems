...
//
//  static {
//    models = new Cache<>(IntArrays.HASH_STRATEGY, ModelGemArmor::new,
//        new ModelGemArmor(new int[]{0, 0, 0, 0}), 256, 5000L, ModelGemArmor::dispose);
...
//    float scale = 0.2f;
//
//    // @formatter:off              modelBase,   texX,texY,xOff, yOff,    zOff,  dx,dy, dz,scale,(mirrored)
...
//    EntityEquipmentSlot slot = bipedHead.showModel ? EntityEquipmentSlot.HEAD :
//        !bipedBody.showModel ? EntityEquipmentSlot.FEET :
//            bipedLeftLeg.showModel && bipedRightLeg.showModel ? EntityEquipmentSlot.LEGS :
...
//
//  @Override
//  public void setRotationAngles(float swing, float amount, float age, float yaw, float pitch,
...
//  }
//
//  protected void fixArmorStand(Entity stand, float swing, float swingAmount, float age, float yaw,
