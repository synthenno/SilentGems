...
public class ToolData {
  ...
  static ToolData readFromNBT(NBTTagCompound tags) {
    ...
    data.isSG2Tool = construction.getBoolean(NBT_COMPAT_SG2);
    if (!data.isSG2Tool) {
      // Detect unmarked SG2 tools.
      if (getPart(construction, "Head0") != null) {
        data.isSG2Tool = true;
      }
    }
  ...
  static ToolPart getPart(NBTTagCompound tags, String key) {
    ...
    // Still doing the split on '#' for SG2 compatibility.
