...
public class RenderEnderSlime extends RenderLiving<EntityEnderSlime> {
  ...
  private static final ResourceLocation ENDER_SLIME_TEXTURES = new ResourceLocation(
      SilentGems.RESOURCE_PREFIX + "textures/entity/ender_slime.png");

  public RenderEnderSlime(RenderManager renderManagerIn) {
